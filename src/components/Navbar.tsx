        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-8">
              {[
                { id: "equilibrio-perfeito", text: "O Equilíbrio Perfeito" },
                { id: "opcoes-investimento", text: "Opções de Investimento" },
                { id: "fronteira-valorizacao", text: "Valorização" },
                { id: "analisando-oportunidade", text: "Análise" },
                { id: "conheca-bitupita", text: "Sobre Bitupitá" },
              ].map((link, index) => (
                <motion.button
                  key={link.text}
